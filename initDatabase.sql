...
INSERT INTO Account 
VALUES
	(N'admin',			N'admin',	'admin@gmail.com',		 '1', 'admin'   ,'2003-06-20', N'Việt Nam'					 , N'Việt Nam', '99999999999'),
	(N'Phong',			N'Dep Trai','phongdeptrai@gmail.com','2', 'customer','2003-06-22', N'123 Đường A, Quận 1, TP HCM', N'Việt Nam', '1111111111'),
	(N'Nguyễn Văn',		N' A',		'nguyenvana@gmail.com',	 '3', 'employee','2003-06-20', N'123 Đường A, Quận 1, TP HCM', N'Việt Nam', '0225588999'),
	(N'Trần Thị',		N' B',		'tranthin@gmail.com',	 '4', 'employee','2003-06-20', N'456 Đường B, Quận 2, TP HCM', N'Việt Nam', '0225588999'),
	(N'Lê Văn',			N' C',		'levanc@gmail.com',		 '5', 'employee','2003-06-20', N'789 Đường C, Quận 3, TP HCM', N'Việt Nam', '0225588777'),
	( N'Nguyễn Thị',	N' D',		'nguyenthid@mgmail.com', '6', 'employee','2003-06-20', N'321 Đường D, Quận 4, Hà Nội', N'Việt Nam', '0225588666'),
	(N'Trần Văn',		N' E',		'tranvane@gmail.com',	 '7', 'employee','2003-06-20', N'654 Đường E, Quận 5, Hà Nội', N'Việt Nam', '0225588555')
...
VALUES
		...
		(N'Trưởng phòng kinh doanh', 4),
		( N'Nhân viên tư vấn', 5),
		(N'Nhân viên bán hàng', 6),
		(N'Nhân viên kỹ thuật', 7)
...
INSERT INTO Product 
VALUES 
	(N'Apollo Justice Ace Attorney Trilogy', 1226254,0.1,10, 1, 1, N'Ngày phát hành: Apollo Justice: Ace Attorney Trilogy được phát hành vào ngày 21 tháng 2 năm 2019.
...
(N'Celeste', 980000,0.1,10, 1, 2, N'Ngày phát hành: Celeste được phát hành vào ngày 25 tháng 1 năm 2018.
...
(N'DeadCells_ReturntoCastlevaniaEdition', 245054,0.1,10, 1, 3, N'Ngày phát hành: Dead Cells: Return to Castlevania Edition đã được phát hành vào ngày 6 tháng 3 năm 2023. Phiên bản vật lý của trò chơi đã được phát hành vào ngày 11 tháng 8 năm 2023.
...
(N'Disney Illusion Island', 850000,0.1,10, 1, 3, N'Ngày phát hành: Disney Illusion Island đã được phát hành vào ngày 28 tháng 7 năm 2023.
...
(N'Double Dragon Collection', 980954,0.1,10, 1, 2, N'Ngày phát hành: Double Dragon Collection được phát hành vào ngày 29 tháng 1 năm 2020.
...
(N'Double Dragon Gaiden_Rise Of The Dragons', 613004,0.1,10, 1, 2, N'Ngày phát hành: Double Dragon Gaiden: Rise of the Dragons đã được phát hành vào ngày 27 tháng 7 năm 2023.
...
(N'Double Dragon IV.', 171464,0.1,10, 1, 2, N'Ngày phát hành: Double Dragon Gaiden IV đã được phát hành vào ngày 27 tháng 7 năm 2023.
...
(N'HogwartsLegacy', 1471554,0.1,10, 1, 4, N'Ngày phát hành: Hogwarts Legacy đã được phát hành vào ngày 10 tháng 2 năm 2023.
...
(N'Pokémon Scarlet The Hidden Treasure of Area Zero DLC', 1380000,0.1,10, 1, 6, N'Ngày phát hành: Pokémon Scarlet + The Hidden Treasure of Area Zero DLC được phát hành vào ngày 14 tháng 12 năm 2023.
...
(N'Pokémon Violet The Hidden Treasure of Area Zero DLC', 2150000,0.1,10, 1, 1, N'Ngày phát hành: Pokémon Violet + The Hidden Treasure of Area Zero DLC được phát hành vào ngày 14 tháng 12 năm 2023.
...
(N'Prince Of Persia_The Lost Crown', 1300000,0.1,10, 1, 3, N'Ngày phát hành: Prince of Persia: The Lost Crown được phát hành vào ngày 18 tháng 1 năm 2024.
...
(N'Red Dead Redemption 1', 1230000,0.1,10, 1, 3, N'Ngày phát hành: Red Dead Redemption 1 được phát hành vào ngày 18 tháng 5 năm 2010.
...
(N'Sonic Original Plus', 1080000,0.1,10, 1, 2, N'Ngày phát hành: Sonic Origins Plus được phát hành vào ngày 23 tháng 6 năm 2023.
...
Bộ nhớ: 6 GB'),
(N'Sonic Super Stars', 1471554,0.1,10, 1, 5, N'Ngày phát hành: Sonic Superstars đã được phát hành vào ngày 17 tháng 10 năm 2023.
...
(N'Star Wars Heritage Pack', 1500000,0.1,10, 1, 4, N'Ngày phát hành: Star Wars Heritage Pack đã được phát hành vào ngày 27 tháng 4 năm 2023. Phiên bản vật lý của trò chơi đã được phát hành vào ngày 8 tháng 12 năm 2034.
...
(N'Tunic', 1050000,0.1,10, 1, 4, N'Ngày phát hành: Tunic đã được phát hành vào ngày 16 tháng 3 năm 2022.
...
INSERT INTO Product 
VALUES 
	(N'AEW_Fight Forever',8734320,0.1,10,1,1,N'Ngày phát hành: AEW Fight Forever được phát hành vào ngày 29 tháng 6 năm 2023.
...
P/S: Tuy được khen ngợi vì phong cách chơi game kiểu arcade quay lại, nhưng bị chỉ trích vì giới hạn trong việc trình bày, chế độ, và tùy chỉnh.'),
	(N'Afterimage_Deluxe Edition',14954644,0.1,10,1,2,N'Ngày phát hành: Afterimage Deluxe Edition được phát hành vào ngày 25 tháng 4 năm 2023.
...
P/S: là một người thích combat và wibu thì đây là một trải nghiệm rất thú vị của admin (O w O).'),
	(N'Alice Gear AegisCS_Concertoof Simulatrix',14954644,0.11,10,1,1,N'Ngày phát hành: Alice Gear Aegis CS_Concerto of Simulatrix được phát hành vào ngày 7 tháng 9 năm 2022.
...
Phiên bản đầy đủ của trò chơi Alice Gear Aegis CS_Concerto of Simulatrix.'),
	(N'Bramble_The Mountain King',14954644,0.12,10,1,1,N'Ngày phát hành: Bramble: The Mountain King được phát hành vào ngày 27 tháng 4 năm 2023.
...
Dung lượng lưu trữ: 8 GB'),
	(N'Call Of Duty_Modern Warface III',6839839,0.13,10,1,1,N'Ngày phát hành: Call of Duty: Modern Warfare III được phát hành vào ngày 10 tháng 11 năm 2023.
...
Bộ nhớ video: 2 GB'),
	(N'Clash_Artifactsof Chaos-Zeno Edition',1515470,0.14,10,1,1,N'Ngày phát hành: Clash: Artifacts of Chaos - Zeno Edition được phát hành vào ngày 9 tháng 3 năm 2023.
...
Dung lượng lưu trữ: 12 GB'),
	(N'EA_SPORTS FC24',1925815,0.15,10,1,1,N'Ngày phát hành: EA SPORTS FC 24 được phát hành vào ngày 29 tháng 9 năm 2023.
...
Kết nối Internet: Tốc độ internet tối thiểu 512kbps. Yêu cầu kết nối internet để cài đặt và chơi.'),
	(N'Grandblue Fantasy_Relink',1215260,0.16,10,1,1,N'Ngày phát hành: Granblue Fantasy: Relink được phát hành vào ngày 1 tháng 2 năm 2024.
...
DirectX: Phiên bản 11'),
	(N'Hogwarts Legacy',8861477,0.17,10,1,1,N'Ngày phát hành: Hogwarts Legacy đã được phát hành vào ngày 10 tháng 2 năm 2023.
...
P/S: siêu phẩm, change my mind.'),
	(N'Like A Dragon Gaiden_The Man Who Erased His Name',10853734,0.18,10,1,1,N'Ngày phát hành: Like A Dragon Gaiden: The Man Who Erased His Name được phát hành vào ngày 9 tháng 11 năm 2023.
...
Dung lượng RAM video: 2048 MB'),
	(N'Marve lron Man VR',4258754,0.19,10,1,1,N'Ngày phát hành: Marvel Iron Man VR được phát hành vào ngày 3 tháng 7 năm 2020 cho PlayStation VR và sau đó được phát hành cho Meta Quest 2 vào ngày 3 tháng 11 năm 2022.
...
Dung lượng lưu trữ tối thiểu: 50 GB.'),
	(N'Naruto X Boruto Ultimate Ninja Storm Connections',10465667,0.11,10,1,1,N'Ngày phát hành: Naruto X Boruto Ultimate Ninja Storm Connections được phát hành vào ngày 17 tháng 11 năm 2023.
...
DirectX: Phiên bản 11.'),
	(N'Persona 3 Reload',9869695,0.12,10,1,1,N'Ngày phát hành: Persona 3 Reload được phát hành vào ngày 2 tháng 2 năm 2024.
...
Dung lượng lưu trữ: 30 GB.
DirectX: Phiên bản 12.'),
	(N'Prince Of Persia_The Lost Crown',2023908,0.13,10,1,3,N'Ngày phát hành: Prince of Persia: The Lost Crown được phát hành vào ngày 18 tháng 1 năm 2024.
...
Card đồ họa: NVIDIA GeForce GTX 950 (2GB VRAM) hoặc AMD Radeon RX 5500 XT (4GB VRAM)
Dung lượng lưu trữ: 30 GB'),
	(N'Red Dead Redemption 1',10010639,0.14,10,1,4,N'Ngày phát hành: Red Dead Redemption 1 được phát hành vào ngày 18 tháng 5 năm 2010.
...
Đồ họa: NVIDIA GeForce 6100 hoặc AMD Radeon HD 2400 Pro
Lưu trữ: 8 GB không gian trống trên ổ cứng'),
	(N'Sonic Original Plus',7100740,0.15,10,1,1,N'Ngày phát hành: Sonic Origins Plus được phát hành vào ngày 23 tháng 6 năm 2023.
...
Bộ xử lý: Intel Core i5-2400, 3.1 GHz hoặc AMD FX-8350, 4.2 GHz
Bộ nhớ: 6 GB'),
	(N'Sonic Super Stars',7220366,0.17,10,1,2,N'Ngày phát hành: Sonic Superstars đã được phát hành vào ngày 17 tháng 10 năm 2023.
...
Bộ nhớ: 6 GB RAM
Đồ họa: NVIDIA GeForce GTS 450 1 GB hoặc AMD Radeon HD 5770 1 GB'),
	(N'Street Fighter 6',2313288,0.16,10,1,6,N'Ngày phát hành: Street Fighter 6 được phát hành vào ngày 2 tháng 6 năm 2023.
...
Dung lượng lưu trữ: 60 GB.'),
	(N'WoLong_Fallen Dynasty',9466184,0.18,10,1,5,N'Ngày phát hành: We Long: Fallen Dynasty được phát hành vào ngày 6 tháng 2 năm 2024.
...
Dung lượng lưu trữ: 60 GB.'),
	(N'WWE2K23 Deluxe Edition',4777950,0.1,10,1,1,N'Ngày phát hành: WWE 2K23 Deluxe Edition được phát hành vào ngày 14 tháng 3 năm 2023.
...
Dung lượng lưu trữ: 80 GB.'),
	(N'Avatar_Frontiersof Pandora',7465208,0.11,10,1,2,N'Ngày phát hành: Avatar: Frontiers of Pandora được phát hành vào ngày 7 tháng 12 năm 2023.
...
Card đồ họa: AMD RX 5700 8GB, Intel Arc A750 8 GB với ReBAR on, NVIDIA GeForce GTX 1070 8GB.'),
	(N'Call Of Duty_Modern Warface III',13538296,0.21,10,1,3,N'Ngày phát hành: Call of Duty: Modern Warfare III được phát hành vào ngày 10 tháng 11 năm 2023.
...
Card đồ họa: NVIDIA GeForce GTX 960 hoặc Radeon RX 470
Bộ nhớ video: 2 GB'),
	(N'EA_SPORTS FC24',12114921,0.21,10,1,4,N' Ngày phát hành: EA SPORTS FC 24 được phát hành vào ngày 29 tháng 9 năm 2023.
...
DirectX: Phiên bản 12
Kết nối Internet: Tốc độ internet tối thiểu 512kbps. Yêu cầu kết nối internet để cài đặt và chơi.'),
	(N'EA SPORTS F123',6597636,0.31,10,1,3,N'Ngày phát hành: EA SPORTS F1 23 được phát hành vào ngày 16 tháng 6 năm 2023.
...
Dung lượng lưu trữ: 80 GB.'),
	(N'EA SPORTS WRC23',2823863,0.11,10,1,4,N'Ngày phát hành: EA SPORTS WRC 23 được phát hành vào ngày 3 tháng 11 năm 2023.
...
Sound Card: DirectX Compatible.'),
	(N'F1 Manager 2023',11664146,0.13,10,1,5,N'Ngày phát hành: F1 Manager 2023 được phát hành vào ngày 31 tháng 7 năm 2023.
...
Dung lượng lưu trữ: 30 GB.'),
	(N'God of Rock',11480597,0.12,10,1,6,N'Ngày phát hành: God of Rock được phát hành vào ngày 17 tháng 4 năm 2023.
...
Dung lượng lưu trữ: Yêu cầu một hệ điều hành và bộ xử lý 64-bit.'),
	(N'Horizon Forbidden West Complete Edition',7784310,0.17,10,1,1,N'Ngày phát hành trên PS5: 6 tháng 10 năm 2023.
...
Dung lượng lưu trữ: 60 GB.'),
	(N'Killer Frequency',6597636,0.18,10,1,2,N'Ngày phát hành: 1 tháng 6 năm 2023.
...
Dung lượng lưu trữ: 2 GB.'),
	(N'Like A Dragon Gaiden_The Man Who Erased His Name',12796523,0.1,10,1,3,N'Ngày phát hành: Like A Dragon Gaiden: The Man Who Erased His Name được phát hành vào ngày 9 tháng 11 năm 2023.
...
Card đồ họa: NVIDIA GeForce GTX 960, 2 GB hoặc AMD Radeon RX 460, 2 GB hoặc Intel Arc A380, 6 GB
Dung lượng RAM video: 2048 MB'),
	(N'Lords Of The Fallen',978919,0.1,10,1,4,N'Ngày phát hành: 13 tháng 10 năm 2023.
...
Dung lượng lưu trữ: 45 GB.'),
	(N'Prince Of Persia_The Lost Crown',6597636,0.19,10,1,5,N'Ngày phát hành: Prince of Persia: The Lost Crown được phát hành vào ngày 18 tháng 1 năm 2024.
...
Card đồ họa: NVIDIA GeForce GTX 950 (2GB VRAM) hoặc AMD Radeon RX 5500 XT (4GB VRAM)
Dung lượng lưu trữ: 30 GB'),
	(N'Remnant 2',11815984,0.1,10,1,6,N'Ngày phát hành: 25 tháng 7 năm 2023.
...
Dung lượng lưu trữ: 80 GB.'),
	(N'Robo Cop_Rouge City',6597636,0.11,10,1,1,N'Ngày phát hành: 2 tháng 11 năm 2023.
...
Dung lượng lưu trữ: 51 GB.'),
	(N'Tekken 8',13701391,0.12,10,1,2,N'Ngày phát hành: 26 tháng 1 năm 2024.
...
Dung lượng lưu trữ: 100 GB.'),
	(N'The Last Of Us_Part II Remastered',9742513,0.13,10,1,3,N'Ngày phát hành: 19 tháng 1 năm 2024.
...
INSERT INTO Product
VALUES
	(N'lite blue',8333641,0.1,10,2,4,N'Nintendo Switch Lite là một hệ thống nhỏ gọn, nhẹ nhàng, tập trung vào việc chơi game di động. Với thiết kế đơn khối thanh lịch, bộ điều khiển được tích hợp ngay vào hệ thống, Nintendo Switch Lite rất phù hợp cho việc chơi game di động.
...
Pin: Từ 3 đến 7 giờ tùy thuộc vào game bạn chơi'),
	(N'lite coral',6597636,0.17,10,2,5,N'Nintendo Switch Lite màu san hô là một hệ thống nhỏ gọn, nhẹ nhàng, tập trung vào việc chơi game di động. Với thiết kế đơn khối thanh lịch, bộ điều khiển được tích hợp ngay vào hệ thống, Nintendo Switch Lite rất phù hợp cho việc chơi game di động.
...
Pin: Từ 3 đến 7 giờ tùy thuộc vào game bạn chơi
'),
	(N'lite gray',8391199,0.1,10,2,6,N'Nintendo Switch Lite màu xám là một hệ thống nhỏ gọn, nhẹ nhàng, tập trung vào việc chơi game di động. Với thiết kế đơn khối thanh lịch, bộ điều khiển được tích hợp ngay vào hệ thống, Nintendo Switch Lite rất phù hợp cho việc chơi game di động.
...
Bộ nhớ trong: 32 GB, có thể mở rộng bằng thẻ microSD lên đến 2TB
Pin: Từ 3 đến 7 giờ tùy thuộc vào game bạn chơi'),
	(N'lite isablle aloha',2268717,0.1,10,2,1,N'Nintendo Switch Lite Isabelle Aloha Edition là một hệ thống nhỏ gọn, nhẹ nhàng, tập trung vào việc chơi game di động. Với thiết kế đơn khối thanh lịch, bộ điều khiển được tích hợp ngay vào hệ thống, Nintendo Switch Lite rất phù hợp cho việc chơi game di động. Hệ thống có màu san hô đáng yêu, một họa tiết lá trắng ở phía sau, và một thiết kế lá dễ thương ở phía trước, lấy cảm hứng từ series Animal Crossing™.
...
Pin: Từ 3 đến 7 giờ tùy thuộc vào game bạn chơi
'),
	(N'lite pokemon diagla and palkia',3662423,0.1,10,2,2,N'Nintendo Switch Lite Dialga & Palkia Edition là một hệ thống nhỏ gọn, nhẹ nhàng, tập trung vào việc chơi game di động. Hệ thống này là phiên bản đầu tiên có thân máy màu xám kim loại với các nút màu đen. Mặt sau có hình vẽ nghệ thuật ấn tượng của Pokémon huyền thoại Dialga và Palkia từ các game Pokémon Brilliant Diamond và Pokémon Shining Pearl trong một hoàn thiện màu bạc và vàng.
...
Bộ nhớ trong: 32 GB, có thể mở rộng bằng thẻ microSD lên đến 2TB
Pin: Từ 3 đến 7 giờ tùy thuộc vào game bạn chơi'),
	(N'lite timmy and tommy aloha',10552102,0.1,10,2,3,N'Nintendo Switch Lite Timmy & Tommy’s Aloha Edition là một hệ thống nhỏ gọn, nhẹ nhàng, tập trung vào việc chơi game di động. Hệ thống này có màu xanh ngọc thạch, với một họa tiết lá trắng ở phía sau và một họa tiết lá nâu ở phía trước, gần nút Home. Hệ thống này đi kèm với một bản sao số hoá đầy đủ của game Animal Crossing: New Horizons.
...
Bộ nhớ trong: 32 GB, có thể mở rộng bằng thẻ microSD lên đến 2TB
Pin: Từ 3 đến 7 giờ tùy thuộc vào game bạn chơi'),
	(N'lite turquoise',6597636,0.1,10,2,4,N'Nintendo Switch Lite Turquoise là một hệ thống nhỏ gọn, nhẹ nhàng, tập trung vào việc chơi game di động. Với thiết kế đơn khối thanh lịch, bộ điều khiển được tích hợp ngay vào hệ thống, Nintendo Switch Lite rất phù hợp cho việc chơi game di động.
...
RAM: 4GB.
Bộ nhớ trong: 32 GB.'),
	(N'lite yellow',6596585,0.1,10,2,5,N'Nintendo Switch Lite Yellow là một hệ thống nhỏ gọn, nhẹ nhàng, tập trung vào việc chơi game di động. Với thiết kế đơn khối thanh lịch, bộ điều khiển được tích hợp ngay vào hệ thống, Nintendo Switch Lite rất phù hợp cho việc chơi game di động.
...
Ghi chú: Game The Legend of Zelda: Tears of the Kingdom không được bao gồm.'),
	(N'oled mario',9378479,0.1,10,2,1,N'Mô tả: Nintendo Switch OLED Model - Mario Red Edition có thiết kế đặc biệt từ game Super Mario. Hệ thống này có màu đỏ rực rỡ, với hình ảnh của Mario được in trên phía sau của dock.
...
Kết nối không dây: Wi-Fi (IEEE 802.11 a/b/g/n/ac tương thích) / Bluetooth 4.1.
Pin: Khoảng từ 4.5 đến 9 giờ, tùy thuộc vào game bạn chơi.'),
	(N'oled neon',6597636,0.1,10,2,2,N'Mô tả: Nintendo Switch OLED Model - Neon Blue/Neon Red Edition có màn hình OLED 7 inch sống động, chân đế rộng có thể điều chỉnh, dock có cổng LAN có dây, 64 GB bộ nhớ trong, và âm thanh nâng cao.
...
Kết nối không dây: Wi-Fi (IEEE 802.11 a/b/g/n/ac tương thích) / Bluetooth 4.1.
Pin: Khoảng từ 4.5 đến 9 giờ, tùy thuộc vào game bạn chơi.'),
	(N'oled splatoon',6597636,0.1,10,2,4,N'Mô tả: Nintendo Switch OLED Model - Splatoon 3 Edition có thiết kế đặc biệt từ game Splatoon 3. Hệ thống này có màu xanh dương và vàng gradient, với hình ảnh của Splatoon được in trên phía sau của dock. 
...
Kết nối không dây: Wi-Fi (IEEE 802.11 a/b/g/n/ac tương thích) / Bluetooth 4.1.
Pin: Khoảng từ 4.5 đến 9 giờ, tùy thuộc vào game bạn chơi.'),
	(N'oled white',10094108,0.1,10,2,5,N'Mô tả: Nintendo Switch OLED Model - White là phiên bản Nintendo Switch mới nhất với màn hình OLED 7 inch sống động, chân đế rộng có thể điều chỉnh, dock có cổng LAN có dây, 64 GB bộ nhớ trong, và âm thanh nâng cao.
...
Kết nối không dây: Wi-Fi (IEEE 802.11 a/b/g/n/ac tương thích) / Bluetooth 4.1.
Pin: Khoảng từ 4.5 đến 9 giờ, tùy thuộc vào game bạn chơi.'),
	(N'v2 gray',11655756,0.1,10,2,5,N'Mô tả: Nintendo Switch V2 Gray là phiên bản cải tiến của Nintendo Switch, với màn hình 6.2 inch cho phép bạn chơi game ở chế độ TV, bàn hoặc cầm tay. Hệ thống này bao gồm Nintendo Switch console và Nintendo Switch dock màu đen, và bộ điều khiển Joy‑Con trái và phải màu xám.
...
Kết nối không dây: Wi-Fi (IEEE 802.11 a/b/g/n/ac tương thích) / Bluetooth 4.1.
Pin: Khoảng từ 4.5 đến 9 giờ, tùy thuộc vào game bạn chơi.'),
	(N'v2neon red neon blue',8206515,0.1,10,2,1,N'Mô tả: Nintendo Switch V2 Neon Red/Neon Blue có màn hình 6.2 inch, cho phép bạn chơi game ở chế độ TV, bàn hoặc cầm tay. Hệ thống này bao gồm Nintendo Switch console và Nintendo Switch dock màu đen, và bộ điều khiển Joy‑Con trái và phải màu đỏ neon và xanh dương neon.
...
Pin: Khoảng từ 4.5 đến 9 giờ, tùy thuộc vào game bạn chơi.
Ngày phát hành: Hệ thống này đã được phát hành vào tháng 8 năm 2019.'),
	(N'v2 neon red neon blue nobox',10094108,0.1,10,2,2,N'Mô tả: Nintendo Switch V2 Neon Red/Neon Blue có màn hình 6.2 inch, cho phép bạn chơi game ở chế độ TV, bàn hoặc cầm tay. Hệ thống này bao gồm Nintendo Switch console và Nintendo Switch dock màu đen, và bộ điều khiển Joy‑Con trái và phải màu đỏ neon và xanh dương neon.
...
Ghi chú: Hộp không được bao gồm.'),
	(N'PS2_fat',11275656,0.1,10,4,3,N'Mô tả:
...
P/S: PlayStation 2 "Fat" còn được gọi là "anh trai" trong gia đình PlayStation 2, vì nó to lớn và mạnh mẽ hơn nhiều so với "em bé" Slimline. Nhưng đừng để vẻ ngoài cứng cáp của "anh trai" này làm bạn sợ hãi, bởi vì "anh trai" này cũng rất dễ thương và thân thiện đấy!'),
	(N'PS2_slim',12984802,0.1,10,4,4,N'Mô tả:
...
P/S: Bạn biết không, PlayStation 2 Slimline còn được gọi là “em bé” của dòng PlayStation 2, vì nó nhỏ nhắn và xinh xắn hơn nhiều so với “anh trai” của mình. Nhưng đừng để vẻ ngoài đáng yêu đó lừa dối bạn, “em bé” này vẫn sở hữu sức mạnh không kém gì “anh trai” đâu nhé!'),
	(N'PS3_fat',10094108,0.1,10,4,5,N'Mô tả: PlayStation 3 (PS3) là một hệ thống chơi game video được sản xuất trong nhiều mô hình khác nhau trong suốt chu kỳ đời của nó. Mô hình PS3 “Fat” ban đầu có sẵn với ổ cứng 20 hoặc 60 GB.
...
P/S: “Bạn biết không, PS3 ‘Fat’ không chỉ là một chiếc máy chơi game, mà còn là một máy tập thể dục tuyệt vời - nó nặng hơn bạn nghĩ!”'),
	(N'PS3_slim',8475753,0.1,10,4,6,N'Mô tả: PS3 Slim là một phiên bản thu nhỏ của PlayStation 3, với kích thước nhỏ hơn, nhẹ hơn và tiêu thụ ít năng lượng hơn so với mô hình gốc. Máy có khả năng nâng cấp ổ cứng với dung lượng từ 120 GB đến 320 GB.
...
P/S: Bạn biết không, PS3 Slim màu trắng không chỉ là một chiếc máy chơi game, mà còn là một phần của trang trí nhà cửa với thiết kế đẹp mắt của nó! '),
	(N'PS3_superSlim',11801546,0.1,10,4,2,N'Mô tả: PS3 Super Slim là một hệ thống giải trí gia đình trong một thiết bị nhỏ gọn và thanh lịch, cho phép bạn chơi đĩa Blu-Ray, DVD, CD âm nhạc và xem TV qua BBC, ITV và Channel 4 iPlayer. Nó là một máy chơi game mạnh mẽ được thu nhỏ vào một gói càng nhỏ hơn trong khi duy trì các tính năng giống như các phiên bản trước: một thư viện game tuyệt vời và một loạt các dịch vụ streaming mạnh mẽ, bao gồm Netflix, Amazon, Vudu và NFL Sunday Ticket.
...
P/S: Bạn biết không, PS3 Super Slim có thể nhỏ gọn hơn, nhưng nó vẫn giữ được sức mạnh “siêu” của mình trong mỗi trò chơi!'),
	(N'PS4_days Of Play',5310171,0.1,10,4,3,N'Mô tả: PS4 Days of Play là một phiên bản giới hạn của PlayStation 4, được phát hành như một phần của sự kiện Days of Play của Sony. Sự kiện này là một cách để Sony kỷ niệm và tri ân cộng đồng PlayStation trên toàn thế giới.
...
P/S: Cùng PS4 Days of Play, mỗi ngày đều là một ngày vui vẻ với game!, admin đã được trải nghiệm và cảm giác rất sướng (có thể là do bản giới hạn nhưng kệ đi).'),
	(N'PS4_pro',9951741,0.1,10,4,4,N'Mô tả: PS4 Pro là một phiên bản mạnh mẽ hơn của PlayStation 4, được thiết kế để chơi game ở độ phân giải cao hơn (4K) và thường xuyên trong High Dynamic Range (HDR). PS4 Pro cung cấp trải nghiệm chơi game tuyệt vời hơn và hiển thị chi tiết hơn so với máy PS4 tiêu chuẩn.
...
P/S: chữ Pro đã nói lên tất cả, không thể phủ nhận được.'),
	(N'PS4_slim',2589889,0.1,10,4,5,N'Mô tả: PlayStation 4 Slim, còn được gọi là PS4 Slim, là một phiên bản nhỏ gọn hơn của PlayStation 4 gốc. Nó hỗ trợ toàn bộ thư viện game của PS4, bao gồm cả PS VR. Thiết bị này có thiết kế nhỏ gọn, thanh lịch hơn và có dung lượng lưu trữ lên đến 1TB.
...
P/S: nhỏ gọn, có thể xách vào lớp chơi và không bị phát hiện. +1 lí do để mua.'),
	(N'PS4_standardEdition',10094108,0.1,10,4,6,N'Mô tả: PlayStation 4 Standard Edition, còn được gọi là PS4, là một máy chơi game gia đình được phát triển bởi Sony Interactive Entertainment. Nó hỗ trợ toàn bộ thư viện game của PS4.
...
P/S: Một kĩ nguyên vĩ đại của game console, một huyền thoại trong lòng mọi gamers.'),
	(N'PS4_TLOU Edition',12138373,0.1,10,4,1,N'Mô tả: PlayStation 4 The Last of Us Edition là một phiên bản đặc biệt của PlayStation 4, đi kèm với game The Last of Us Remastered. Game này là một trò chơi hành động phiêu lưu được phát triển bởi Naughty Dog và được xuất bản bởi Sony Computer Entertainment.
...
P/S: The last of us thật sự là một biểu tượng của game sinh tồn. Cốt truyện gay cấn nhưng không kém những màn lấy đi nước mắt của người chơi. Và như một điều dĩ nhiên, PS4 TLOU Edition đã tôn vinh tựa game này bằng chính thiết kế của nó.'),
	(N'PS4_U4 Edition',1313023,0.1,10,4,2,N'Mô tả: PS4 Uncharted 4 Edition là một phiên bản giới hạn của hệ thống PlayStation 4, đi kèm với trò chơi Uncharted 4: A Thief’s End. Bộ sản phẩm bao gồm một hệ thống PlayStation 4 màu xanh lam tối với hình ảnh của Nathan Drake được in lụa, cùng với một tay cầm DualShock 4 phù hợp và một bản Blu-ray của Uncharted 4: A Thief’s End.
...
P/S: Nếu bạn chưa từng trải nghiệm serie Uncharted, bạn đã bỏ lỡ một cuộc phiêu lưu có một không hai trong suốt thế kỉ công nghệ số này.'),
	(N'PS5_digital',10094108,0.1,10,4,3,N'Mô tả: PlayStation 5 Digital Edition là một phiên bản hoàn toàn kỹ thuật số của máy chơi game PS5, không có ổ đĩa. Máy này cho phép bạn trải nghiệm tốc độ tải siêu nhanh với SSD tốc độ cao, sự thấm nhập sâu hơn với hỗ trợ cho phản hồi haptic, các nút điều chỉnh thích ứng, và âm thanh 3D.
...
.'),
	(N'PS5_GOW Edition',9853823,0.1,10,4,5,N'Mô tả: PlayStation 5 God of War Edition là một phiên bản đặc biệt của PS5, tôn vinh trò chơi God of War Ragnarök1. Bộ này bao gồm một máy chơi game tương thích với Blu-Ray, có khả năng Wi-Fi, công nghệ âm thanh 3D.
...
P/S: không có gì phải bàn cãi, God Of War là cái tên được PS5 tôn vinh với bản Limited Edition của nó dành riêng cho huyền thoại này!'),
	(N'PS5_MW Edition',10094108,0.1,10,4,6,N'Mô tả: PlayStation 5 Modern Warfare Edition là một phiên bản đặc biệt của PS5, tôn vinh trò chơi Call of Duty: Modern Warfare III. Bộ này bao gồm một máy chơi game tương thích với Blu-Ray, có khả năng Wi-Fi, công nghệ âm thanh 3D.
...
'),
	(N'PS5_Spiderman Edition',2751409,0.11,10,4,1,N'Mô tả: PlayStation 5 Spiderman Edition là một phiên bản đặc biệt của PS5, tôn vinh trò chơi Marvel’s Spider-Man. Bộ này bao gồm một máy chơi game tương thích với Blu-Ray, có khả năng Wi-Fi, công nghệ âm thanh 3D.
